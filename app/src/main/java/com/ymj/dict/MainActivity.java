...
import com.ymj.dict.bean.TuWenBean;
import com.ymj.dict.utils.FileUtil;
import com.ymj.dict.utils.PatternUtils;
import com.ymj.dict.utils.RecognizeService;
...
//        video.setVideoPath("https://flv2.bn.netease.com/videolib1/1811/26/OqJAZ893T/HD/OqJAZ893T-mobile.mp4");

//        Log.i("ymj", "onCreate: "+Uri.parse("android.resource//"+getPackageName()+"/"+R.raw.video));
